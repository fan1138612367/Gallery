...
class ImageGesture(
    ...
    private val dragCloseHelper: DragCloseHelper
) : AllGesture,
    ...
    private fun initBase() {
        ...
        val scale: Float = if (widthRatio < heightRatio) widthRatio else heightRatio
        val translateX: Float = (viewWidth - sourceWidth * scale) / 2
